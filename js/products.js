(function () {
  ...
  function buildFromCurated() {
    ...
    return window.PRODUCTS_CURATED.map(function (c, idx) {
      ...
      return {
        ...
        priceOnRequest: (c.price_on_request === true || c.price_on_request === "true"),
  ...
  function productCardHtml(p) {
    ...
    var priceHtml = (p.priceOnRequest) ? 'Contact for Price'
      : (p.priceNgn != null && isFinite(p.priceNgn)) ? formatNairaValue(p.priceNgn)
